        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    departmentManyToOneId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Instructors_Departments_departmentManyToOneId",
                        column: x => x.departmentManyToOneId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Course_Insts_Courses_coursesId",
                        column: x => x.coursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Course_Insts_Instructors_instructorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Stud_Courses_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Course_Insts_coursesId",
                table: "Course_Insts",
                column: "coursesId");

            migrationBuilder.CreateIndex(
                name: "IX_Course_Insts_instructorsId",
                table: "Course_Insts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Instructors_departmentManyToOneId",
                table: "Instructors",
                column: "departmentManyToOneId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stud_Courses_StudentsId",
                table: "Stud_Courses",
                column: "StudentsId");
